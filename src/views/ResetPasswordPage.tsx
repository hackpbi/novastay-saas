    ...
    <div className="min-h-screen flex items-center justify-center bg-bg-primary px-4">
      <div className="w-full max-w-[380px] animate-slide-up">
        ...
        <div className="text-center mb-7">
          ...
          <p className="text-sm text-brand-muted">새 비밀번호를 입력해주세요</p>
        </div>
        ...
        <div className="rounded-2xl bg-bg-secondary p-8"
          ...
          {checking ? (
            ...
            <div className="text-center py-4 space-y-3">
              ...
              <p className="text-sm text-brand-muted">링크가 만료되었거나 유효하지 않습니다.</p>
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* 새 비밀번호 */}
              <div>
                <label className="block text-xs font-medium text-brand-muted mb-1.5">새 비밀번호</label>
              ...
              <div>
                ...
                {confirm && password !== confirm && (
                  <p className="mt-1 text-[11px] text-status-negative">비밀번호가 일치하지 않습니다.</p>
                )}
                {confirm && password === confirm && confirm.length >= 8 && (
                  <p className="mt-1 text-[11px] text-status-positive">✓ 비밀번호가 일치합니다.</p>
                )}
              </div>
        ...
        <p className="mt-6 text-center text-xs text-brand-dimmed">
          <button onClick={() => router.push('/login')}
            className="hover:text-brand-muted transition-colors underline underline-offset-2">
            로그인으로 돌아가기
          </button>
        </p>
      </div>
