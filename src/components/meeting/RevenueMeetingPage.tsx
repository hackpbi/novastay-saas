...
export default function RevenueMeetingPage({ hotelId }: RevenueMeetingPageProps) {
  ...
  return (
    <div style={{ minHeight: '100%', background: BG, padding: 0, color: '#fff' }}>
      ...
      {/* 세그먼트 상세 풀스크린 모달 */}
      {segOpen && <SegmentDetailModal open={segOpen} onClose={() => setSegOpen(false)} hotelId={hotelId} monthKey={monthKey} pickupRows={pickupRows} roomCount={roomCount} groups={groups} />}
